        ...
        <div class="login" style="margin-top: 75px; width: 500px; height: 88vh; overflow-y: scroll;">
            ...
            <!-- <div class = "container"> -->
				...
				<div class = "form-group">    
					...
					<input class="form-control" type = "date" name = "DOC" value = "<?php echo $row->DOC ?>" placeholder="Date of Commencement" required/>    
				</div>  
				<div class = "form-group">    
                    <label>Sum Assured: </label>    
                    <input class="form-control" type = "text" name = "Sum_assured" value = "<?php echo $row->Sum_Assured ?>" placeholder="Sum Assured"  required/>    
                </div>
				<div class = "form-group">    
                    <label>Payment Period: </label>    
                    <input class="form-control" type = "text" name = "Payment_period" value = "<?php echo $row->Pay_Period ?>" placeholder="Payment Period"  required/>    
                </div>
				<div class = "form-group">    
                    <label>Insurance Period: </label>    
                    <input class="form-control" type = "text" name = "Ins_period" value = "<?php echo $row->Ins_Period ?>" placeholder="Insurance Period"  required/>    
                </div>
				<div class = "form-group">    
                    <label class="form-label">Premium mode: </label><br>
                    <input class="form-check-input" id="mly" type = "radio" name = "mode" value = "MLY" required <?php if($row->Mode == 'MLY'){ echo "checked"; }?>/>
					<label class="form-check-label" for="mly">Monthly</label>
					<input class="form-check-input" id="yly" type = "radio" name = "mode" value = "YLY" required <?php if($row->Mode == 'YLY'){ echo "checked"; }?>/>
					<label class="form-check-label" for="yly">Yearly</label>
					<input class="form-check-input" id="qly" type = "radio" name = "mode" value = "QLY" required <?php if($row->Mode == 'QLY'){ echo "checked"; }?>/>
					<label class="form-check-label" for="qly">Quarterly</label>
					<input class="form-check-input" id="sss" type = "radio" name = "mode" value = "SSS" required <?php if($row->Mode == 'SSS'){ echo "checked"; }?>/>
